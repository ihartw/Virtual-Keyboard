      ...
      <div class="container">
         <div class="keyboard-container z-depth-3">
            ...
            <div class="row">
               ...
               <div class="col s1">
                  <div class="minor-key" v-on:mousedown=cSharp v-on:mouseup=cSharpStop v-touch:start=cSharp
                     v-touch:end=cSharpStop v-bind:class="{ minorKeyActive: cSharpIsActive }">
               ...
               <div class="col s1">
                  <div class="minor-key" v-on:mousedown=dSharp v-on:mouseup=dSharpStop v-touch:start=dSharp
                     v-touch:end=dSharpStop v-bind:class="{ minorKeyActive: dSharpIsActive }">
                     <div class="key-shadow"></div>
               ...
               <div class="col s1">
                  <div class="minor-key" v-on:mousedown=fSharp v-on:mouseup=fSharpStop v-touch:start=fSharp
                     v-touch:end=fSharpStop v-bind:class="{ minorKeyActive: fSharpIsActive }">
                     <div class="key-shadow"></div>
               ...
               <div class="col s1">
                  <div class="minor-key" v-on:mousedown=gSharp v-on:mouseup=gSharpStop v-touch:start=gSharp
                     v-touch:end=gSharpStop v-bind:class="{ minorKeyActive: gSharpIsActive }">
                     <div class="key-shadow"></div>
               ...
               <div class="col s1">
                  <div class="minor-key" v-on:mousedown=aSharp v-on:mouseup=aSharpStop v-touch:start=aSharp
                     v-touch:end=aSharpStop v-bind:class="{ minorKeyActive: aSharpIsActive }">
                     <div class="key-shadow"></div>
            ...
            <div class="row">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=c3 v-on:mouseup=c3Stop v-touch:start=c3
                  v-touch:end=c3Stop v-bind:class="{ active: cIsActive }">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=d3 v-on:mouseup=d3Stop v-touch:start=d3
                  v-touch:end=d3Stop v-bind:class="{ active: dIsActive }">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=e3 v-on:mouseup=e3Stop v-touch:start=e3
                  v-touch:end=e3Stop v-bind:class="{ active: eIsActive }">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=f3 v-on:mouseup=f3Stop v-touch:start=f3
                  v-touch:end=f3Stop v-bind:class="{ active: fIsActive }">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=g3 v-on:mouseup=g3Stop v-touch:start=g3
                  v-touch:end=g3Stop v-bind:class="{ active: gIsActive }">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=a3 v-on:mouseup=a3Stop v-touch:start=g3
                  v-touch:end=g3Stop v-bind:class="{ active: aIsActive }">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=b3 v-on:mouseup=b3Stop v-touch:start=b3
                  v-touch:end=b3Stop v-bind:class="{ active: bIsActive }">
               ...
               <div class="col s1 major-key z-depth-2" v-on:mousedown=c4 v-on:mouseup=c4Stop v-touch:start=c4
                  v-touch:end=c4Stop v-bind:class="{ active: c4IsActive }">
